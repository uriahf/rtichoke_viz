...
var performanceTableHost = document.querySelector("#performance-table");
var precisionRecallHost = document.querySelector("#precision-recall-chart");
if (!rocHost || !calibrationHost || !precisionRecallHost || !gainsHost || !gainsTimeHost || !liftHost || !liftTimeHost || !performanceTableHost) {
...
performanceTableHost.append(
  renderPerformanceTable(performance_table_default)
);
