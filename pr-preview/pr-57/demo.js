...
function renderReport(spec) {
  ...
  if (!value_exports2.Check(ReportSpecV1_0Schema, spec)) throw new Error("Invalid ReportSpec");
  ...
  components: [
    {
      id: "performance",
      title: "Performance table",
      spec: structuredClone(performance_table_default)
    },
    { id: "roc", title: "ROC", spec: structuredClone(roc_default) },
    {
      id: "calibration",
      title: "Calibration",
      spec: structuredClone(calibration_default)
    },
    {
      id: "precision-recall",
      title: "Precision-recall",
      spec: structuredClone(precision_recall_shared_population_default)
    },
    { id: "gains", title: "Gains", spec: structuredClone(gains_shared_population_default) },
    { id: "lift", title: "Lift", spec: structuredClone(lift_shared_population_default) }
  ]
};
