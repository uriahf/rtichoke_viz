...
const performanceTableHost = document.querySelector<HTMLElement>("#performance-table");
...
performanceTableHost.append(
  renderPerformanceTable(performanceTableFixture as PerformanceTableSpec),
);
